...
const headerModule = () => {
  ...
  navbar.innerHTML =
    '<a href="#" id="home-link">Home</a> <a href = "#" id = "menu-link" > Menu</a> <a href="#" id="contact-link">Contact</a>';
...
const contactModule = () => {
  ...
  contactInfo.innerHTML =
    "<h5> Telephone </h5> <p>+1 415 333 8888</p> <h5> Address</h5> <p>No.1234 College Ave</p> <p>San Mateo, CA, USA</p>";
